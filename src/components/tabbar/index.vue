<template>
  <div class="nav-bar">
    <ul class="nav-list">
        <router-link to="home" tag="li" class="nav-list-item active">
        ...
        <router-link to="mine" tag="li" class="nav-list-item">
            <span class="iconfont iconwo1 span-icon"></span>
            <span class="span-title">我的</span>
        </router-link>
    </ul>
  </div>
</template>
